...
public abstract class IntrospectedTable {
    ...
    protected void calculatePlainJavaAttributes() {
        ...
        for (PlainJavaGeneratorConfiguration plainJavaGeneratorConfiguration : plainJavaGeneratorConfigurations) {
            StringBuilder sb = new StringBuilder();
            sb.append(plainJavaGeneratorConfiguration.getTargetPackage());

            sb.append(fullyQualifiedTable.getSubPackageForClientOrSqlMap(isSubPackagesEnabled(plainJavaGeneratorConfiguration)));
            sb.append('.');
            if (stringHasValue(tableConfiguration.getMapperName())) {
                sb.append(tableConfiguration.getMapperName());
            } else {
            ...
            if ("DAO".equals(plainJavaGeneratorConfiguration.getConfigurationType())){
                setJavaDaoType(s+"Dao");
            }
            if ("DAOIMPL".equals(plainJavaGeneratorConfiguration.getConfigurationType())){
                setJavaDaoImplType(s+"DaoImpl");
            }
            if ("SERVICE".equals(plainJavaGeneratorConfiguration.getConfigurationType())){
                setJavaServiceType(s+"Service");
            }
            if ("SERVICEIMPL".equals(plainJavaGeneratorConfiguration.getConfigurationType())){
                setJavaServiceImplType(s+"ServiceImpl");
            }
        }
    ...
    public String getJavaDaoType() {
        return internalAttributes
                .get(InternalAttribute.ATTR_DAO_TYPE);
    }

    public void setJavaDaoType(String javaDaoType) {
        internalAttributes.put(
                InternalAttribute.ATTR_DAO_TYPE,
                javaDaoType);
    }

    public String getJavaDaoImplType() {
        return internalAttributes
                .get(InternalAttribute.ATTR_DAO_IMPL_TYPE);
    }

    public void setJavaDaoImplType(String javaDaoImplType) {
        internalAttributes.put(
                InternalAttribute.ATTR_DAO_IMPL_TYPE,
                javaDaoImplType);
    }

    public String getJavaServiceType() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SERVICE_TYPE);
    }

    public void setJavaServiceType(String javaServiceType) {
        internalAttributes.put(
                InternalAttribute.ATTR_SERVICE_TYPE,
                javaServiceType);
    }

    public String getJavaServiceImplType() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SERVICE_IMPL_TYPE);
    }

    public void setJavaServiceImplType(String javaServiceImplType) {
        internalAttributes.put(
                InternalAttribute.ATTR_SERVICE_IMPL_TYPE,
                javaServiceImplType);
    }
