...
public class Context extends PropertyHolder {
    ...
    private List<PlainJavaGeneratorConfiguration> plainJavaGeneratorConfigurations;
    ...
    public Context(ModelType defaultModelType) {
        ...
        plainJavaGeneratorConfigurations = new ArrayList<>();
    ...
    public List<PlainJavaGeneratorConfiguration> getPlainJavaGeneratorConfigurations() {
        return plainJavaGeneratorConfigurations;
    }

    public void addPlainJavaGeneratorConfigurations(PlainJavaGeneratorConfiguration plainJavaGeneratorConfiguration) {
        plainJavaGeneratorConfigurations.add(plainJavaGeneratorConfiguration);
    }
