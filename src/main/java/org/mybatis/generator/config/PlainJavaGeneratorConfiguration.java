 ...
 *@author LiuXingHai
 */
public class PlainJavaGeneratorConfiguration extends TypedPropertyHolder {
     ...
     *  
     */
    public PlainJavaGeneratorConfiguration() {
        super();
    }
    ...
    public XmlElement toXmlElement() {
        XmlElement answer = new XmlElement("plainJavaGenerator"); 
