...
public class MyBatisGeneratorConfigurationParser {
    ...
    private void parseContext(Configuration configuration, Node node) {
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            } else if ("plainJavaGenerator".equals(childNode.getNodeName())) { //$NON-NLS-1$
                parsePlainJavaGenerator(context, childNode);
    ...
    private void parsePlainJavaGenerator(Context context, Node node) {
        PlainJavaGeneratorConfiguration plainJavaGeneratorConfiguration = new PlainJavaGeneratorConfiguration();

        context.addPlainJavaGeneratorConfigurations(plainJavaGeneratorConfiguration);
        ...
        plainJavaGeneratorConfiguration.setConfigurationType(type);
        plainJavaGeneratorConfiguration.setTargetPackage(targetPackage);
        plainJavaGeneratorConfiguration.setTargetProject(targetProject);
        plainJavaGeneratorConfiguration
                .setImplementationPackage(implementationPackage);
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            if ("property".equals(childNode.getNodeName())) { //$NON-NLS-1$
                parseProperty(plainJavaGeneratorConfiguration, childNode);
            }
        }
    }
